    ...
    <div class="row align-items-center">
      <div class="col">
        <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
          ...
          <li class="breadcrumb-item active"><a href="<?=base_url('Kayitlar/Pazar')?>"><?=lang('Kayitlar.sayfa.pazarKayitlari')?></a></li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="card-body pb-0">
              ...
              <div class="col-lg-5">
                <div class="mb-3 d-flex align-items-center">
                  <select class="form-select" name="searchType">
                    <option value="item_vnum"><?=lang('Genel.esya')?></option>
                    <option value="buyer_name" selected><?=lang('Genel.karakterAdi')?></option>
                    <option value="item_price"><?=lang('Genel.fiyat')?></option>
                  </select>
                </div>
              </div>
              <div class="col-lg-1">
          ...
          <div class="row">
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"desc"]]' data-page-length='10' id="ajax-datatable" data-url="<?=base_url('Kayitlar/AjaxPazar')?>">
                <thead>
                  <tr>
