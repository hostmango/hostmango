    ...
    <div class="row align-items-center">
      <div class="col">
        <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
          ...
          <li class="breadcrumb-item active"><a href="<?=base_url('Efsun/Nadir')?>"><?=lang('Efsun.sayfa.nadirEfsunAyarlari')?></a></li>
        </ol>
      </div>
      <?php if (IsAllowedViewModule('nadirEfsunDuzenleyebilsin')): ?>
        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"asc"]]' data-page-length='100' id="ajax-datatable" data-url="<?=base_url('Efsun/NadirAjax')?>">
                <thead>
                  <tr>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><?=lang('Efsun.sayfa.nadirDuzenle')?></h5>
        ...
        <form class="Duzenle overflow-auto">
          <div class="modal-body pb-1">
            ...
            <div class="row">
              ...
              <div class="col-3">
                <div class="mb-2">
                  <div class="form-label">costume_body</div>
                  <input type="number" name="costume_body" class="form-control" required>
                </div>
              </div>
              <div class="col-3">
                <div class="mb-2">
                  <div class="form-label">costume_hair</div>
                  <input type="number" name="costume_hair" class="form-control" required>
                </div>
              </div>
              <div class="col-3">
                <div class="mb-2">
          ...
          <div class="modal-footer">
            <div class="row w-100">
              ...
              <div class="col-6">
                <button type="submit" class="btn btn-primary w-100"><?=lang('Efsun.sayfa.nadirDuzenle')?></button>
              </div>
            </div>
          </div>
        </form>
