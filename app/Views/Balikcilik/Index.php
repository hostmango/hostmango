...
<div class="container-xl">
  <div class="page-header d-print-none">
    <div class="row align-items-center">
      <div class="col">
        <h1 class="page-title"><?=lang('Balikcilik.sayfa.balikcilik')?></h1>
      </div>
      <div class="col-auto d-md-flex">
        <?php if (IsAllowedViewModule('balikcilikEkleyebilsin')): ?>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title"><?=lang('Balikcilik.sayfa.ekle')?></h5>
                ...
                <form class="Ekle overflow-auto">
                  <div class="modal-body pb-1">
                    <div class="mb-2">
                      ...
                      <select class="form-control Esyalar" name="vnum"></select>
                    </div>
                    <div class="mb-2">
                  ...
                  <div class="modal-footer">
                    <div class="row w-100">
                      ...
                      <div class="col-6">
                        <button type="submit" class="btn btn-primary w-100"><?=lang('Balikcilik.sayfa.ekle')?></button>
                      </div>
                    </div>
                  </div>
                </form>
        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"asc"]]' data-page-length='10' id="ajax-datatable" data-url="<?=base_url('Balikcilik/Ajax')?>">
                <thead>
                  <tr>
                    ...
                    <?php if (IsAllowedViewModule('balikcilikDuzenleyebilsin') || IsAllowedViewModule('balikcilikSilebilsin')): ?>
      ...
      <div class="modal-content">
        ...
        <form class="Duzenle overflow-auto">
          <div class="modal-body pb-1">
            ...
            <div class="mb-2">
              <div class="form-label"><?=lang('Genel.sans')?></div>
              <input type="number" name="newChance" class="form-control" value="0">
            </div>
          ...
          <div class="modal-footer">
            <div class="row w-100">
              ...
              <div class="col-6">
                <button type="submit" class="btn btn-primary w-100"><?=lang('Balikcilik.sayfa.duzenle')?></button>
              </div>
            </div>
          </div>
        </form>
