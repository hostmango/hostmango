...
<div class="container-xl">
  <div class="page-header d-print-none">
    <div class="row align-items-center">
      <div class="col">
        <h1 class="page-title"><?=lang('Cark.sayfa.cark')?></h1>
      </div>
      <div class="col-auto d-md-flex">
        <?php if (IsAllowedViewModule('carkEkleyebilsin')): ?>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title"><?=lang('Cark.sayfa.ekle')?></h5>
                ...
                <form class="Ekle overflow-auto">
                  ...
                  <div class="modal-footer">
                    <div class="row w-100">
                      ...
                      <div class="col-6">
                        <button type="submit" class="btn btn-primary w-100"><?=lang('Cark.sayfa.ekle')?></button>
                      </div>
                    </div>
                  </div>
                </form>
        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"asc"]]' data-page-length='25' id="ajax-datatable" data-url="<?=base_url('Cark/Ajax')?>">
                <thead>
                  <tr>
                    ...
                    <?php if (IsAllowedViewModule('carkDuzenleyebilsin') || IsAllowedViewModule('carkSilebilsin')): ?>
        ...
        <form class="Duzenle overflow-auto">
          ...
          <div class="modal-footer">
            <div class="row w-100">
              ...
              <div class="col-6">
                <button type="submit" class="btn btn-primary w-100"><?=lang('Cark.sayfa.duzenle')?></button>
              </div>
            </div>
          </div>
        </form>
