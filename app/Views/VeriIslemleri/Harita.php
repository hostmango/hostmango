    ...
    <div class="row align-items-center">
      <div class="col">
        <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
          ...
          <li class="breadcrumb-item active"><a href="<?=base_url('VeriIslemleri/Harita')?>"><?=lang('VeriIslemleri.sayfa.haritaIsimleri')?></a></li>
        </ol>
      </div>
      <div class="col-auto d-md-flex">
        <?php if (IsAllowedViewModule('haritaIsimEkleyebilsin')): ?>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title"><?=lang('VeriIslemleri.sayfa.haritaEkle')?></h5>
                ...
                <form class="Ekle overflow-auto">
                  ...
                  <div class="modal-footer">
                    <div class="row w-100">
                      ...
                      <div class="col-6">
                        <button type="submit" class="btn btn-primary w-100"><?=lang('VeriIslemleri.sayfa.haritaEkle')?></button>
                      </div>
                    </div>
                  </div>
                </form>
        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"asc"]]' data-page-length='100' id="ajax-datatable" data-url="<?=base_url('VeriIslemleri/AjaxHarita')?>">
                <thead>
                  <tr>
                    <th class="ps-2" data-width="1%"><?=lang('Genel.id')?></th>
                    <th class="ps-2"><?=lang('Genel.isim')?></th>
                    <?php if (IsAllowedViewModule('haritaIsimDuzenleyebilsin') || IsAllowedViewModule('haritaIsimSilebilsin')): ?>
        ...
        <form class="Duzenle overflow-auto">
          ...
          <div class="modal-footer">
            <div class="row w-100">
              ...
              <div class="col-6">
                <button type="submit" class="btn btn-primary w-100"><?=lang('VeriIslemleri.sayfa.haritaDuzenle')?></button>
              </div>
            </div>
          </div>
        </form>
