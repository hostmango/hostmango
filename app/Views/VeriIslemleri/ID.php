    ...
    <div class="row align-items-center">
      <div class="col">
        <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
          ...
          <li class="breadcrumb-item active"><a href="<?=base_url('VeriIslemleri/ID')?>"><?=lang('VeriIslemleri.sayfa.efsunIsimleriID')?></a></li>
        </ol>
      </div>
        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"asc"]]' data-page-length='100' id="ajax-datatable" data-url="<?=base_url('VeriIslemleri/AjaxID')?>">
                <thead>
                  <tr>
