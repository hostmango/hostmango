...
<div class="container-xl">
  <div class="page-header d-print-none">
    <div class="row align-items-center">
      <div class="col">
        <h1 class="page-title"><?=lang('GM.sayfa.gm')?></h1>
      </div>
      <div class="col-auto d-md-flex">
        <?php if (IsAllowedViewModule('gmEkleyebilsin')): ?>
          <a href="javascript:void(0)" class="btn btn-dark me-2" data-bs-toggle="modal" data-bs-target="#gmEkle">
          ...
          <div class="modal modal-blur fade" id="gmEkle" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title"><?=lang('GM.sayfa.ekle')?></h5>
                ...
                <form class="Ekle overflow-auto">
                  <div class="modal-body pb-1">
                    <div class="mb-2">
                      ...
                      <input type="text" name="mAccount" class="form-control" required>
                    </div>
                    <div class="mb-2">
                      <div class="form-label"><?=lang('Genel.karakterAdi')?></div>
                      <input type="text" name="mName" class="form-control" required>
                    </div>
                    <div class="mb-2">
                      <div class="form-label"><?=lang('Genel.yetki.yetki')?></div>
                      <select class="form-control" name="mAuthority">
                  ...
                  <div class="modal-footer">
                    <div class="row w-100">
                      ...
                      <div class="col-6">
                        <button type="submit" class="btn btn-primary w-100"><?=lang('GM.sayfa.ekle')?></button>
                      </div>
                    </div>
                  </div>
                </form>
        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <div class="table-responsive mb-0 mt-0">
              <table class="table table-striped table-borderless border-0 text-muted pt-2" data-order='[[0,"asc"]]' data-page-length='100' id="ajax-datatable" data-url="<?=base_url('GM/Ajax')?>">
                <thead>
                  <tr>
                    <th class="ps-2" data-width="1%" data-class="text-left text-truncate">#</th>
                    <th class="ps-2" data-class="text-truncate max-width-300"><?=lang('Genel.kullaniciAdi')?></th>
                    <th class="ps-2" data-class="text-truncate max-width-300"><?=lang('Genel.karakterAdi')?></th>
                    <th class="ps-2" data-class="text-truncate max-width-300"><?=lang('Genel.yetki.yetki')?></th>
                    <?php if (IsAllowedViewModule('gmDuzenleyebilsin') || IsAllowedViewModule('gmSilebilsin')): ?>
        ...
        <form class="Duzenle overflow-auto">
          ...
          <div class="modal-footer">
            <div class="row w-100">
              ...
              <div class="col-6">
                <button type="submit" class="btn btn-primary w-100"><?=lang('GM.sayfa.duzenle')?></button>
              </div>
            </div>
          </div>
        </form>
