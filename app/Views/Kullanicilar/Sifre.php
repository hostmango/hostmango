    ...
    <div class="row align-items-center">
      <div class="col-auto d-md-flex" style="line-height:40px">
        <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
          ...
          <li class="breadcrumb-item active"><a href="<?=base_url('Kullanicilar/Sifre/'.$kullaniciBilgileri->user_id)?>"><?=lang('Hesap.sayfa.sifre')?></a></li>
        </ol>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="alert alert-info">
            <?=lang('Kullanicilar.sayfa.sifreDegistirNot')?>
          </div>
          <form class="SifreDegistir">
            <div class="mb-2">
              <div class="form-label"><?=lang('Kullanicilar.sayfa.yeniSifre')?></div>
            ...
            <div class="form-footer mt-2">
              <button type="submit" class="btn btn-primary w-100"><?=lang('Kullanicilar.sayfa.sifreDegistir')?></button>
            </div>
          </form>
        </div>
      </div>
