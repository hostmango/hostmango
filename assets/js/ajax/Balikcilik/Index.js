$(document).ready(function(){
  ...
  $(document).on('click','[data-bs-target="#duzenle"]', function(event) {
    ...
    $('.Duzenle [name="newChance"]').val($(this).data('chance'));
    $('.Duzenle [name="vnum"]').val($(this).data('vnum'));
    $('.Duzenle [name="chance"]').val($(this).data('chance'));
  });
  $(".Duzenle").on("submit", function(e){
    var data = new FormData(this);
    $.ajax({
      type: "post",
      url: url+"/Balikcilik/Duzenle",
      contentType: false,
      processData: false,
      data: data,
      beforeSend: function(){
  ...
  $(".SunucuyaGonder").on("submit", function(e){
    ...
    $.ajax({
      type: "post",
      url: url+"/Balikcilik/SunucuyaGonder",
      contentType: false,
      processData: false,
      data: data,
      beforeSend: function(){
