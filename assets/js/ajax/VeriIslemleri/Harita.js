$(document).ready(function(){
  ...
  $(".Ekle").on("submit", function(e){
    ...
    $.ajax({
      type: "post",
      url: url+"/VeriIslemleri/EkleHarita",
      contentType: false,
      processData: false,
      data: data,
      beforeSend: function(){
  ...
  $(document).on('click','[data-bs-target="#duzenle"]', function(event) {
    ...
    $.ajax({
      type: "get",
      url: url+"/VeriIslemleri/DetayHarita/"+id,
      beforeSend: function(){
        $(".site_loading").show();
      },
      success: function(response){
  ...
  $(".Duzenle").on("submit", function(e){
    ...
    $.ajax({
      type: "post",
      url: url+"/VeriIslemleri/DuzenleHarita",
      contentType: false,
      processData: false,
      data: data,
      beforeSend: function(){
  ...
  $(document).on('click','.haritaSil',function(e) {
    Swal.fire({
    ...
    .then((result) => {
      if (result.value) {
        ...
        $.ajax({
          type: "post",
          url: url+"/VeriIslemleri/SilHarita",
          data: {id},
          success: function(response){
            if (response.error) {
              toastr["error"](response.error);
